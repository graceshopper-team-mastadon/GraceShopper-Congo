                            ...
                            <div class="card p-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check2" name="option2" onClick={handleSelect1} />
                        ...
                        <div class="col-lg-4 mb-lg-0 mb-3">
                            <div class="card p-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <small><span class="fw-bold">Name:</span><span>{name}</span></small>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check2" name="option2" onClick={handleSelect2} />
                                        <small><label class="form-check-label" for="check2">Select Payment Method</label></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 mb-lg-0 mb-3">
                            <div class="card p-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <small><span class="fw-bold">Name:</span><span>{name}</span></small>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check2" name="option2" onClick={handleSelect3} />
                                        <small><label class="form-check-label" for="check2">Select Payment Method</label></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 mb-lg-0 mb-3">
                            <div class="card p-3">
                                ...
                                <div class="add-card">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="check2" name="option2" onClick={handleNewCard} />
                                        <small><label class="form-check-label" for="flexCheckChecked" >Enter New Payment Method</label></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-lg-7">
                                                <form action="" class="form">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form__div">
                                                                <input type="text" class="form-control" value={cardnumber} onChange={(e) => setCardNumber(e.target.value)} />
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form__div">
                                                                <input type="text" class="form-control" value={date} onChange={(e) => setDate(e.target.value)} />
                                                                <label for="" class="form__label">MM/YYYY</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form__div">
                                                                <input type="password" class="form-control" value={cvv} onChange={(e) => setCVV(e.target.value)} />
                                            ...
                                            <div class="col-lg-7">
                                                <form action="" class="form">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form__div">
                                                                <input type="text" class="form-control" value={shippingAddress} />
